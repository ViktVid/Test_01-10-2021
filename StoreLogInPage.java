...
//		return driver.findElement(By.id("login2"));
        ...
        /*ZASTO SU DEFINISANA POLJA IZNAD A U METODAMA GET SE PREPISUJU?
         * MORAS SE ODLUCITI GDE CES DEFINISATI VREDNOSTI, U POLJIMA ILI KAO PROMENJIVE
         * U METODAMA.
         * u TOM SLUCAJU SVA POLJA IZNAD SU VISAK.
         * ILI NPR. AKO VEC ZELIS OVAKO: */

        this.logInButton = driver.findElement(By.id("login2"));
